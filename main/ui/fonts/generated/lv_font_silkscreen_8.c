 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --no-compress --no-prefilter --no-kerning --bpp 1 --size 8 --font .\fonts\Silkscreen\Silkscreen-Regular.ttf -r 0x20-0x7F --format lvgl -o .\fonts\generated\lv_font_silkscreen_8.c --lv-font-name lv_font_silkscreen_8 --force-fast-kern-format
 ******************************************************************************/

#include "lvgl.h"

#ifndef LV_FONT_SILKSCREEN_8
#define LV_FONT_SILKSCREEN_8 1
#endif

#if LV_FONT_SILKSCREEN_8
...
const lv_font_t lv_font_silkscreen_8 = {
