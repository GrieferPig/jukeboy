...
public:
    ...
    */
    static bool IRAM_ATTR _onSent(i2s_chan_handle_t handle, i2s_event_data_t *event, void *user_ctx)
    {
    ...
    /**
        ...
        @return True if a task was woken up (FreeRTOS xHigherPriorityTaskWoken)
    */
    static bool IRAM_ATTR _onSentUnder(i2s_chan_handle_t handle, i2s_event_data_t *event, void *user_ctx)
    {
